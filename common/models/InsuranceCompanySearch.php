...
/**
 * InsuranceCompanySearch represents the model behind the search form about `common\models\InsuranceCompany`.
 */
class InsuranceCompanySearch extends InsuranceCompany
{
    ...
    public function rules()
    {
        return [
            [['id'], 'integer'],
            [['company_title', 'company_description', 'companyImageUrl'], 'safe'],
        ];
    }
