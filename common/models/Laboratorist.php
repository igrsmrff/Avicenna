...
/**
 * This is the model class for table "{{%laboratorists}}".
 *
 * @property integer $id
 * @property string $name
 * @property string $address
 * @property string $phone
 * @property string $laboratoristImageUrl
 ...
 * @property User $user
 */
class Laboratorist extends \common\overrides\db\ActiveRecord
{
    ...
    public function rules()
    {
        return array_merge(
            [
                [['name','phone'],'required'],
                [['name', 'address', 'phone','laboratoristImageUrl'], 'string', 'max' => 255],
    ...
    public function attributeLabels()
    {
        return array_merge(
            ...
            [
                ...
                'laboratoristImageUrl' => Yii::t('common', 'Laboratorist Image Url'),
