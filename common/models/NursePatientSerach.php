...
/**
 * NursePatientSerach represents the model behind the search form about `common\models\NursePatientPivot`.
 */
class NursePatientSerach extends NursePatientPivot
{
    public $name;
    public $address;
    public $phone;
    ...
    {
        return [
            [['id', 'nurse_id', 'patient_id'], 'integer'],
            [[
                'name',
                'address',
                'phone',
    ...
    public function search($params)
    {
        ...
        $query
            ...
            ->andFilterWhere([Nurse::tableName() . '.id'=> $this->nurse_id]);
